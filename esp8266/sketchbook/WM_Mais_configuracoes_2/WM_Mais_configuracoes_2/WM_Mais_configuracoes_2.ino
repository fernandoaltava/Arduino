...
///////////////////////////
// SSID de rede de configuracão WifiManager //
...
void setup() {
  ...
  //end read
  ////////////////////////////////////////////
  //  Botão Habilita configuração WifiManager /////////////////
  ...
  if ( digitalRead(button_config) == HIGH ) {
    ...
    WiFiManagerParameter custom_server_emoncms("char_server_emoncms", "Firebase URL", char_server_emoncms, 40,
        "title= \"Parameter 1: server or Host Emoncms example: 192.168.0.12 or domainemoncms.com\"");

    WiFiManagerParameter custom_port_emoncms("char_port_emoncms", "Pino", char_port_emoncms, 4,
        "title= \"Parameter 2: Port 80 default \"   type=\"number\"  ,  min=\"1\" max=\"9999\"   ");

    WiFiManagerParameter custom_apikey_emoncms("char_apikey_emoncms", "apikey write", char_apikey_emoncms, 33,
