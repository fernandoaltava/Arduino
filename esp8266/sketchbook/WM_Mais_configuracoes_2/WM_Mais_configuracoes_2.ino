...
char char_firebase_url[40] = "serveremoncms.com";
  ...
  if (SPIFFS.begin()) {
    ...
    if (SPIFFS.exists("/config.json")) {
      ...
      if (configFile) {
        ...
        if (json.success()) {
          Serial.println("\nparsed json");
          strcpy(char_firebase_url, json["char_firebase_url"]);
////          strcpy(char_server_emoncms, json["char_server_emoncms"]);
  ...
  if ( digitalRead(button_config) == HIGH ) {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    WiFiManagerParameter custom_server_emoncms("char_firebase_url", "Firebase URL", char_firebase_url, 40, "title= \"Parameter 1: server or Host Emoncms example: 192.168.0.12 or domainemoncms.com\"");
    ...
    strcpy(char_firebase_url, custom_server_emoncms.getValue());
////    strcpy(char_server_emoncms, custom_server_emoncms.getValue());
  ...
  if (shouldSaveConfig) {
    ...
    json["char_firebase_url"] = char_firebase_url;
////    json["char_server_emoncms"] = char_server_emoncms;
  ...
  if (WiFi.SSID() == "") {
    ...
    ///// debug serial ///////////////////
    Serial.println(char_firebase_url);
