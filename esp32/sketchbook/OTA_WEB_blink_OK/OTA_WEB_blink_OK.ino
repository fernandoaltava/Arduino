...
const char* ssid = "Luana2"; /* coloque aqui o nome da rede wi-fi que o ESP32 deve se conectar */
const char* password = "40224022"; /* coloque aqui a senha da rede wi-fi que o ESP32 deve se conectar */
