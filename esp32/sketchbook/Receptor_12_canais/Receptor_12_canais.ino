...
#define SIGNAL_TIMEOUT 1000  // Este é o tempo limite do sinal em milissegundos. Iremos redefinir os dados se não houver sinal
...
{
  // A posição intermediária do joystick. (254/2=127)
