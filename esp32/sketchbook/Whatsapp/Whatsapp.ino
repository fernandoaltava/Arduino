...
const char* ssid = "Recanto Reencontro 5.8GHZ";             //Add your WiFi ssid
const char* password =  "40224022";    //Add your WiFi password

String apiKey = "342118";              //Add your Token number that bot has sent you on WhatsApp messenger
String phone_number = "+5511976885823"; //Add your WhatsApp app registered phone number (same number that bot send you in url)
